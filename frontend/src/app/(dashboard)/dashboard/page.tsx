...
import {
  ...
  User as UserIcon, ShieldCheck, Sparkles, ArrowRight, Play
} from "lucide-react";
          ...
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-400 max-w-xl leading-relaxed">
                Your company-specific coding preparation workspace is ready. Practice problem patterns curated for your target recruiters.
              </p>
            </div>
